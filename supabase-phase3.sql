...
-- Seed default pricing data (using ARRAY[...] syntax for text[] column)
...
('sfx','Basic','3,000','/ pack','Quick custom SFX for short-form content.',ARRAY['10 custom SFX','WAV format 48kHz','2 revisions per sound','3-day turnaround'],false,1),
('sfx','Standard','8,000','/ pack','Comprehensive SFX for web series and ad films.',ARRAY['30 custom SFX','Categorised library','WAV + AIFF formats','Unlimited revisions','5-day turnaround'],true,2),
